strength = [
    ...
    [2.58, 6.58, 2.26, 1.98, 1.77, 1.40, 1.19, 1.10, 1.03, 0.95, 0.86, 0.80, 0.74],
    [2.14, 1.62, 5.48, 1.82, 1.67, 1.32, 1.10, 0.89, 0.84, 0.76, 0.70, 0.64, 0.59],
    [1.66, 1.33, 1.20, 4.53, 1.62, 1.28, 2.06, 0.83, 0.63, 0.58, 0.52, 0.47, 0.42],
    ...
    [0.45, 0.25, 0.17, 0.10, 0.06, 0.01, 0.00, 0.00, 0.00, 0.04, 0.00, 0.00, 0.87],
]
...
deck = [c + s for c in "23456789TJQKA" for s in "CSHD"]
# deck = [
#     "AC",
#     "2C",
#     "3C",
