        ...
        if player.fold == False:
            ...
            for p in copy_pot:
                ...
                if not remaining:
                    ...
                    new = [remaining + c_call, remaining * (len(p[3]) + 1) + c_pot, player.all_in, p[3] | {player}]
                    p[1] -= len(p[3]) * remaining
                    new_pot.append(new)
                    new_pot.append(p)
                    remaining = 0
            ...
            if remaining:
                new_pot.append([remaining + c_call, remaining + c_pot, player.all_in, {player}])
